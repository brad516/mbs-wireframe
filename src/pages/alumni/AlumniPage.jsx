...
const getInvolved = [
  ...
  { to: '/give', title: 'Sponsor a Future Citizen', desc: 'Your tax-deductible gift of $500 fully sponsors a citizen. Pay it forward and send the next generation to Boys State.', cta: 'Donate', color: 'bg-gold' },

...
const tabs = [
  {
    ...
    items: [
      ...
      { question: 'What is Boys Nation?', answer: 'Boys Nation is a national program where the top two representatives from each state\u2019s Boys State convene in Washington, D.C. for a week of government simulation at the federal level. Missouri sends two senators each year.' },
  ...
  },
  {
    ...
    items: [
      ...
      { question: 'Do I need political experience?', answer: 'Absolutely not. Boys State is designed for students from all backgrounds and interests. Many citizens discover a passion for civic engagement they never knew they had.' },
  ...
  },
  {
    label: 'Parents',
    items: [
      { question: 'Is Boys State safe?', answer: 'Yes. Citizens are supervised 24/7 by trained adult counselors on the secure Lindenwood University campus. Medical staff are on-site at all times. All staff are background-checked.' },
      { question: 'How much does it cost?', answer: 'There is no cost to families. Every citizen is fully sponsored through a $500 sponsorship funded by alumni, local businesses, and community organizations. We do not accept payment from parents or families. If you\u2019d like to give back, you can pay it forward by sponsoring a future citizen.' },
  ...
  },
  {
    ...
    items: [
      ...
      { question: 'Is there a cost to the school?', answer: 'No. There is no cost to the school or the student\u2019s family. Every citizen is fully sponsored by alumni, businesses, and community organizations.' },

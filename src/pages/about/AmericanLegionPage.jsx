...
const timeline = [
  ...
  { year: '1960s', title: 'Program Expansion', desc: 'Delegate counts grow past 1,000. The program becomes recognized as one of the premier civic education experiences in the state.' },
  ...
  { year: '2010', title: 'Alumni Association Founded', desc: 'The Missouri Boys State Alumni Association is established to connect the growing network of over 50,000 former delegates.' },
  { year: '2020s', title: 'New Era', desc: 'Missouri Boys State moves to Lindenwood University and continues to evolve, reaching 1,600 delegates annually while honoring its founding principles.' },
]
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-500 leading-relaxed mb-4">
                The American Legion, Department of Missouri, has sponsored and operated Missouri Boys State since 1938. Local Legion posts across the state are the backbone of the program \u2014 identifying, nominating, and often sponsoring the outstanding young men who become delegates.
              </p>
      ...
      <section className="bg-navy py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-white/70 mb-6">Contact us to learn more about nominating delegates and supporting Missouri Boys State.</p>

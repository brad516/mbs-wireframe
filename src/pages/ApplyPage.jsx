...
const faqItems = [
  ...
  { question: 'What does it cost to attend?', answer: 'There is no cost to families. Every citizen is fully sponsored through a $500 sponsorship funded by alumni, local businesses, and community organizations. We do not accept payment from parents or families \u2014 finances are never a barrier to attending Boys State.' },
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white border border-gray-200 rounded-xl p-7">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Every citizen is <strong className="text-navy">fully sponsored</strong>. We do not accept payment from parents or families. Finances are never a barrier to attending Boys State.
              </p>
            </div>
            <div className="bg-white border border-gray-200 rounded-xl p-7">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Each citizen&rsquo;s $500 sponsorship is funded by MBS alumni, local businesses, American Legion posts, and community organizations who believe in investing in Missouri&rsquo;s future leaders.
              </p>
            </div>
            <div className="bg-white border border-gray-200 rounded-xl p-7">

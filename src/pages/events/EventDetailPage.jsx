...
const eventData = {
  trivia: {
    ...
    description: 'Test your knowledge and support Missouri Boys State scholarships.',
    date: 'Saturday, April 18, 2026',
    time: '6:00 PM \u2013 10:00 PM',
    location: 'The Coliseum, St. Louis, MO',
    details: 'Join us for our annual trivia fundraiser! Assemble a team of up to 8 players and compete for prizes while supporting MBS scholarships. The evening includes dinner, a silent auction, and plenty of fun. All proceeds directly fund delegate scholarships for the 2026 session.',
